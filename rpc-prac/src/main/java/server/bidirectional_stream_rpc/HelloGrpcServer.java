...
public class HelloGrpcServer {
	 ...
	 *
	 * This method initializes a gRPC server with the following configuration:
	 * - Listens on port 8080
	 * - Adds an implementation of the HelloGrpcService
	 * - Starts the server and blocks until the server is terminated
	 *
