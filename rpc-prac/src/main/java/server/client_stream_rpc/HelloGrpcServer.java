...
public class HelloGrpcServer {
	 ...
	 *
	 * This method initializes a gRPC server with a HelloGrpcServiceImpl service implementation,
	 * starts the server, and blocks the main thread until the server is terminated.
	 *
